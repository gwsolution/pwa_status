...
import { UtilityServiceType } from 'src/providers/pojo/utility-service-type';
import { UtilityServiceTypeClient } from 'src/providers/server-util/utility-service-type-client.service';
...
@Component({
  selector: 'app-utility-service-type',
  templateUrl: './utility-service-type.page.html',
  styleUrls: ['./utility-service-type.page.scss'],
})
export class UtilityServiceTypePage implements OnInit {
  ...
  constructor(private alertController: AlertController,
    ...
    private serverClient: UtilityServiceTypeClient, private activatedRoute: ActivatedRoute, private server: serverClient, private util: commonUtil, private router: Router) { }
  ...
  update(serviceType: UtilityServiceType) {
    this.isEnabled = true;
